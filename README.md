...
```sh
~/tpPOO/tp1-VotreUsername (master*)$ git add .
~/tpPOO/tp1-VotreUsername (master*)$ git commit -m "Validation de l'exercice 1"
~/tpPOO/tp1-VotreUsername (master)$ git push origin master
```
